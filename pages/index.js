...
const categories = ["wet-waste", "dry-waste", "hazardous-waste", "sanitary-waste", "e-waste"];
...
export default function Home() {
  ...
  const [availableItems, setAvailableItems] = useState([...wasteItems]);
